...
/**
 * TFS Services - UNIQUE IMAGES FIX V6 (CORRECT FILE UPLOAD)
 * 
 * Ensures:
 * - hero_image is populated via actual FILE UPLOAD from filesystem
 * - film-permits uses correct images
 */
migrate((app) => {
    const servicesData = {
        "equipment-hire": {
            hero_image_path: "./web/public/images/services/equipment/hero.webp",
            sections: [
                {
                    type: "text_image",
        ...
        "film-shipping": {
            hero_image_path: "./web/public/images/services/shipping/hero.jpg",
            sections: [
                {
                    type: "text_image",
        ...
        "film-permits": {
            hero_image_path: "./web/public/images/services/permits/hero.jpg",
            sections: [
                {
                    type: "text_image",
        ...
        "crewing": {
            hero_image_path: "./web/public/images/services/crewing/hero.jpg",
            sections: [
                {
                    type: "text_image",
        ...
        "scouting": {
            hero_image_path: "./web/public/images/services/scouting/hero.jpg",
            sections: [
                {
                    type: "text_image",
        ...
        "catering": {
            hero_image_path: "./web/public/images/services/catering/hero.jpg",
            sections: [
                {
                    type: "text_image",
        ...
        "accommodation": {
            hero_image_path: "./web/public/images/services/accommodation/luxury-hotel.jpg",
            sections: [
                {
                    type: "text_image",
        ...
        "transportation": {
            hero_image_path: "./web/public/images/services/transportation/hero.jpg",
            sections: [
                {
                    type: "text_image",
                ...
                },
                {
                    ...
                    layout: "right",
                    image: "/images/services/transportation/vehicle-fleet.jpg"
                }
            ]
        },
        "casting": {
            hero_image_path: "./web/public/images/services/casting/hero.jpg",
            sections: [
                {
                    type: "text_image",
        ...
        if (data) {
            ...
            if (data.hero_image_path) {
                try {
                    ...
                    // NOTE: Paths are relative to where pocketbase binary is running
                    const file = $filesystem.fileFromPath(data.hero_image_path);
                    service.set("hero_image", file);
                } catch (err) {
                    console.log(`[Migration] Warning: Could not find/load file for ${slug}: ${data.hero_image_path} - Error: ${err}`);
                }
            }
            ...
            app.save(service);
            console.log(`[FIXED V6] Updated: ${slug}`);
        }
    });

    console.log("[Migration] Force update with FILE UPLOADS completed");
}, (app) => { });
