...
Write-Host "🏗️ Building Web Image (tfs-web)..." -ForegroundColor Cyan
docker build -t tfs-web:latest -f deployment\web\Dockerfile .\web

Write-Host "🏗️ Building PocketBase Image (tfs-pb)..." -ForegroundColor Cyan
...
Write-Host "COPY Copying configuration files..." -ForegroundColor Cyan
