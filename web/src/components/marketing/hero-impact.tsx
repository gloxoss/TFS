...
// TFS Cinema Rental Hero Images - Optimized WebP versions (all under 500KB)
const HERO_IMAGES = [
    "/images/hero/localize-uu-YGo9YVDw-unsplash-1-scaled.webp", // 225KB
    "/images/hero/20221115_124804.webp", // 210KB (compressed from 4MB)
    "/images/hero/xrabat-wall.webp", // 439KB (compressed from 1.2MB)
];
...
export default function HeroImpact({ lng = 'en' }: HeroImpactProps) {
    ...
    return (
        <div ref={containerRef} className="relative h-[80vh] min-h-[600px] sm:min-h-[700px] lg:h-screen lg:min-h-[1100px] w-full isolation-isolate overflow-hidden font-sans selection:bg-red-600 selection:text-white">
            ...
            {/* MEGA TEXT (Bottom Split) - GPU accelerated with will-change + velocity blur */}
