                ...
                {!isOpen && (
                    ...
                    >
                        ...
                        <Button
                            ...
                            radius="lg"
                            size="lg"
                            onPress={() => { setIsOpen(true); setHasInteracted(true) }}
                            aria-label="Open chat"
                        >
                            <motion.div
                                className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent"
                                animate={{ x: ['-100%', '200%'] }}
                                transition={{ repeat: Infinity, duration: 3, repeatDelay: 5, ease: 'linear' }}
                            />
                            <MessageCircle className="w-6 h-6 text-white group-hover:scale-110 transition-transform duration-300 relative z-10" />
                        </Button>
                        {/* Online indicator */}
